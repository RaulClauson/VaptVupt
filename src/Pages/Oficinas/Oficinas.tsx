        ...
        <div className="div_oficinas">
          <div className="map">
            <LoadScript googleMapsApiKey="AIzaSyBs7NUNGoxc9piEik-7t8R0n6jBfdf8E38">
              ...
              >
                {oficinaData
                  .filter((oficina) => oficina.id === selectedOficinaId) // Show only the selected oficina
                  .map((oficina) => (
                    <Marker
                      key={oficina.id}
                      position={{
                      ...
                      icon={{
                        url: "https://res.cloudinary.com/dr0nki74e/image/upload/v1729621415/vapt-vupt/Maps/xw6sz9d9si1rxjlurhoo.png", // Blue pin
                      }}
                    />
                  ))}
              </GoogleMap>
